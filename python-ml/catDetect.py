...
def readImage(selectedEye, videoUrl, imageQueue):
  ...
  while True:
    ...
    if not ret:
      ...
      message = "@command(node:\"/predictions/cat\",lane:\"setLatest\"){\"" + resultStr + "\"}"
      # print(message)
    ...
    message = "@command(node:\"/predictions/cat\",lane:\"setFramenumber\"){\"" + str(frame_num) + "\"}"
    # print(message)
    swimSocket.send(message)      

    message = "@command(node:\"/predictions/cat\",lane:\"setFps\"){\"" + str(fps) + "\"}"
    # print(message)
    swimSocket.send(message)      
